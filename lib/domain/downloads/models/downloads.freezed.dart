...
class _$DownloadsImpl implements _Downloads {
  ...
  @override
  String toString() {
    return 'Downloads(posterPath: $posterPath, backdropPath: $backdropPath, title: $title, overview: $overview)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, posterPath, backdropPath, title, overview);
...
abstract class _Downloads implements Downloads {
  const factory _Downloads(
      ...
      required final String? overview}) = _$DownloadsImpl;
