...
ComingSoonResp _$ComingSoonRespFromJson(Map<String, dynamic> json) =>
    ComingSoonResp(
      dates: json['dates'] == null
          ? null
          : ComingSoonDates.fromJson(json['dates'] as Map<String, dynamic>),
...
ComingSoonDates _$ComingSoonDatesFromJson(Map<String, dynamic> json) =>
    ComingSoonDates(
      maximum: json['maximum'] as String?,
      minimum: json['minimum'] as String?,
    );

Map<String, dynamic> _$ComingSoonDatesToJson(ComingSoonDates instance) =>
    <String, dynamic>{
