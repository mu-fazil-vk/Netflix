...
mixin _$FastLaughState {
  List<VideoResultData> get videosList => throw _privateConstructorUsedError;
...
abstract class $FastLaughStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<VideoResultData> videosList, bool isLoading, bool isError});
}
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl(
      {required final List<VideoResultData> videosList,
      required this.isLoading,
      required this.isError})
      : _videosList = videosList;

  final List<VideoResultData> _videosList;
  @override
  List<VideoResultData> get videosList {
